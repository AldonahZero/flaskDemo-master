...
def get_LBP_excels(path_cutimg, path_excels_save):
    f = xlwt.Workbook()
    sheet1 = f.add_sheet('LBP_correlation', cell_overwrite_ok=True)
    row0 = ['c/nc', 'v/i', 'h', 'angle1', 'angle2', 'angle3', 'angle4', 'angle5', 'angle6', 'angle7',
            'angle8', 'angle9', 'angle10']
            ...
            for filename3 in os.listdir(path2):
                ...
                for i in range(10):
                    ...
                    if img_target is None:
                        ...
                        sheet1.write_merge(q, q, i + 3, i + 3, 'NA')
                    ...
                    if sign:
                        ...
                        everage_contrast = corr_gust / cnt

                    sheet1.write_merge(q, q, i + 3, i + 3, everage_contrast)
                    # print(i)

    f.save(path_excels_save + '/' + 'excel_LBP.xls')
    return


# get_LBP_excels('D:/Python/Python/WZ_GLDM/webNew2/static/images_GLCM',
