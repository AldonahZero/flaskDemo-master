            ...
            for filename3 in os.listdir(path2):
                ...
                for w in range(10):  # 十个角度
                    ...
                    for j in range(9):  # 周围八个背景+目标
                        ...
                        for i, (m1, m2) in enumerate(matches):
                            if m1.distance < 0.85 * m2.distance:  # 两个特征向量之间的欧氏距离，越小表明匹配度越高。
                                ...
                                if i % 5 == 0:
                                    ...
                                    cv2.circle(target_gray, (int(pt2[0]), int(pt2[1])), 5, (255, 0, 255), -1)
                        ...
                        res = cv2.drawMatchesKnn(back_gray, kp1, target_gray, kp2, matches, None, **draw_params)
